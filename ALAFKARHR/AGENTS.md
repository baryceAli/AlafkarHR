...
<!-- Keep work focused: inspect only task-relevant files, reuse existing project patterns, avoid unrelated refactoring, and preserve current business logic, routes, DTOs, permissions, services, and APIs unless the user explicitly asks to change them. -->
