...
namespace Catalog.Data.Migrations
{
    ...
    [Migration("20260708170011_OdooGapMitigationCatalog")]
    partial class OdooGapMitigationCatalog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Catalog.Products.Models.Product", b =>
                {
                    ...
                    b.Property<decimal>("VendorTaxRate")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("Catalog.Products.Models.ProductSku", b =>
                {
                    ...
                    b.Property<int?>("RemovalTimeDays")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyId", "ProductId", "BrandId", "PackageId", "SkuCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("Catalog.Products.Models.Unit", b =>
                {
                    ...
                    b.Property<bool>("IsReferenceUnit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("CompanyId", "UnitCategory", "IsReferenceUnit")
                        .IsUnique()
