    ...
    : ICommandHandler<UpdateProductSkuCommand, UpdateProductSkuResult>
{
    public async Task<UpdateProductSkuResult> Handle(UpdateProductSkuCommand command, CancellationToken cancellationToken)
    {
        ...
        productSku.Update(
            ...
            productionType,
            trackingMode,
            command.ProductSku.ExpirationDate,
            command.ProductSku.ShelfLifeDays,
            command.ProductSku.RemovalTimeDays,
            command.ProductSku.AlertTimeDays,
            command.ProductSku.GalleryImageUrls,
            companyId,
