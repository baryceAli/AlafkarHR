...
namespace Organization.Data.Migrations
{
    ...
    [Migration("20260624180903_AddAdministrationHigherManagementFlag")]
    partial class AddAdministrationHigherManagementFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Organization.Organizations.Models.Administration", b =>
                {
                    ...
                    b.Property<bool>("IsHigherManagement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Organization.Organizations.Models.Branch", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "Specialization");
            ...
            modelBuilder.Entity("Organization.Organizations.Models.UserBranchRoleAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "UserId", "BranchId", "TemplateKey")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("UserBranchRoleAssignments", "Organization");
                });
