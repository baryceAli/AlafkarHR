...
public record StockReservationCommand(CreateInventoryAggregateDto InventoryAggregate) : ICommand<StockReservationResult>;
public record StockReservationResult(Guid Id);

public class StockReservationCommandValidator : AbstractValidator<StockReservationCommand>
{
    public StockReservationCommandValidator()
    {
...
public class StockReservationHandler(InventoryDbContext dbContext, ISender sender, IHttpContextAccessor httpContextAccessor)
    : ICommandHandler<StockReservationCommand, StockReservationResult>
{
    public async Task<StockReservationResult> Handle(StockReservationCommand command, CancellationToken cancellationToken)
    {
