...
public interface IDocumentManagementService
{
    ...
    Task<ApiResult<DocumentUploadOptionsDto>> GetUploadOptionsAsync();
    Task<ApiResult<DocumentUploadPolicyDto>> GetUploadPolicyAsync();
    Task<ApiResult<DocumentUploadPolicyDto>> GetDefaultUploadPolicyAsync();
    Task<ApiResult<DocumentUploadPolicyDto>> UpdateUploadPolicyAsync(UpdateDocumentUploadPolicyDto policy);
    ...
    Task<ApiResult<UpdateDeleteResponseDto>> DeleteStorageAsync(Guid id);
