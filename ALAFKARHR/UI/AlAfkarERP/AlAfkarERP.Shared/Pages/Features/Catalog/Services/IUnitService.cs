...
public interface IUnitService
{
    ...
    public Task<ApiResult<PaginatedResult<UnitDto>>> GetByCompanyAsync(Guid companyId, int PageIndex, int PageSize,string? searchText="", bool includeInactive = false);
